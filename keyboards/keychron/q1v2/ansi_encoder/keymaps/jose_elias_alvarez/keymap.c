...
static uint16_t delay_globe_timer = 0;
static bool     delay_globe_armed = false;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ansi_82(
        ...
        GLB,      KC_LALT,  KC_LGUI,                                NAV,                                    KC_RGUI,  FN,         KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [_GAME] = LAYOUT_ansi_82(
        ...
        KC_LCTL,  KC_LALT,  KC_LGUI,                                KC_SPC,                                 KC_RGUI,  FN,         KC_RALT,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [_NAV] = LAYOUT_ansi_82(
        ...
        KC_LCTL,  KC_LALT,  KC_LGUI,                                _______,                                KC_RGUI,  _______,    KC_RCTL,  _______,  _______,  _______),
    ...
    switch (keycode) {
        case GLB:
            if (record->event.pressed) {
                delay_globe_timer = timer_read();
                delay_globe_armed = true;
            } else {
                delay_globe_armed = false;
            }
            return false;
    }
    return true;
...
void matrix_scan_user(void) {
    if (delay_globe_armed && timer_elapsed(delay_globe_timer) > 100) {
