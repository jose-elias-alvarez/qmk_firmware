...
tap_dance_action_t tap_dance_actions[] = {[TD_GRV] = ACTION_TAP_DANCE_FN(dance_grv)};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_65_ansi_blocker(
        ...
        KC_CAPS, KC_LALT, KC_LGUI,                            NAV,                                FN,      KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_NAV] =   LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            XXXXXXX,                            XXXXXXX, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX
    ),
