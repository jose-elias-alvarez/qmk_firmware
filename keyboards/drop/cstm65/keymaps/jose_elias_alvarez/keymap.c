...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_65_ansi_blocker(
        GRV_TRP, NUM_F1,  NUM_F2,  NUM_F3,  NUM_F4,  NUM_F5,  NUM_F6,  NUM_F7,  NUM_F8,  NUM_F9,  NUM_F10, NUM_F11, NUM_F12, KC_BSPC, KC_DEL,
        TAB_SWC, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_END,
        ...
        KC_CAPS, ALT_LCH, KC_LGUI,                            NAV,                                FN,      KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
